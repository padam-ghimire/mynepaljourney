        ...
        <div class="card b-radius--10">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap justify-content-end mt-3">
                    <button class="btn btn--danger me-3 confirmationBtn"
                        data-question="@lang('Are you sure to reject this documents?')"
                        data-action="{{ route('admin.agencies.kyc.reject', $user->id) }}"><i
                    ...
                    <button class="btn btn--success confirmationBtn"
                        ...
                        data-action="{{ route('admin.agencies.kyc.approve', $user->id) }}"><i
