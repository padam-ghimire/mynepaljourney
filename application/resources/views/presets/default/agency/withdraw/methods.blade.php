...
@section('content')
    <div class="row mb-4 justify-content-center">
        <div class="col-lg-6">
            <div class="base--card">
                <form action="{{route('agency.withdraw.money')}}" method="post">
                    @csrf
                    <div class="row gy-3">
                        <div class="col-lg-12">
                            <p>@lang('Your Current Amount'): {{$general->cur_sym}}{{showAmount(agency()->balance)}}</p>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form--label">@lang('Method')</label>
                                <select class="form-control form--control form-select form--select" name="method_code" required>
