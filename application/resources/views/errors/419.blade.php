            ...
            <div class="row gy-5 justify-content-center align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="error-wrap text-start">
                        ...
                        <h2 class="title text-center mb-3">@lang('Page Expired')</h2>
                        <p class="desc text-center">@lang('Reload and try again.') <a
                                href="{{route('home')}}" class="text--base-two">@lang('Go To Home')?</a></p>
                    </div>
                </div>
            </div>
        </div>
