...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'agency.check.status' => \App\Http\Middleware\AgencyCheckStatus::class,
        ...
        'agency.check' => \App\Http\Middleware\AgencyCheck::class,
        'agency.registration.complete' => \App\Http\Middleware\AgencyRegistrationStep::class,

        'agency.kyc' => \App\Http\Middleware\AgencyKycMiddleware::class,
